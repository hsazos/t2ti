...
def Artist_list(request):
  ...
  if request.method =='GET':
    ...
    if serializer.is_valid():
      ...
      serializer.validated_data["albums"] = "artists/" + serializer.validated_data["id"] +"/albums"
      serializer.validated_data["tracks"] = "artists/" + serializer.validated_data["id"] +"/tracks"
      serializer.validated_data["self_url"] = "artists/" + serializer.validated_data["id"]
      serializer.save()
      serializer.validated_data["url"] = serializer.validated_data["self_url"]
...
def artist_albums(request, artist_id):
  if request.method == 'GET':
    ...
    if serializer.is_valid():
      serializer.validated_data["artist"] = "/artist/" + str(artist_id)
      serializer.validated_data["tracks"] = "/albums/" + serializer.validated_data["id"] + "/tracks"
      serializer.validated_data["self_url"] = "/albums/" + serializer.validated_data["id"]
      serializer.save()
      serializer.validated_data["url"] = serializer.validated_data["self_url"]
      del serializer.validated_data["self_url"]
...
def tracks_by_album(request, album_id):
  ...
  if request.method == "POST":
    ...
    if serializer.is_valid():
      ...
      serializer.validated_data["album"] = "albums/" + str(album_id)
      serializer.validated_data["self_url"] = "tracks/" +str(serializer.validated_data["id"])
      serializer.validated_data["artist"] = "artists/" + str(album_id)
      serializer.save()
      serializer.validated_data["url"] = serializer.validated_data["self_url"]
      del serializer.validated_data["self_url"]
